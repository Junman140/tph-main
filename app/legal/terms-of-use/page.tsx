      ...
      <div className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p>
              Welcome to The Peculiar House Global website. By accessing and using this website, you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to abide by these terms, please do not use this website.
            </p>
            ...
            <p>
              Some features of our website may require registration. You agree to provide accurate and complete information during the registration process and to update such information to keep it accurate and current. You are responsible for safeguarding the password you use to access our website and for any activities or actions under your password.
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4">User Contributions</h2>
            <p>
              Our website may contain message boards, chat rooms, personal profiles, forums, prayer requests, and other interactive features where you can post, submit, publish, display, or transmit content. By providing any user contribution, you grant us the right to use, reproduce, modify, adapt, publish, translate, distribute, and display such content worldwide.
            </p>
            <p>
            ...
            <ul className="list-disc pl-6 mb-6">
              ...
              <li>All content is accurate and does not violate these Terms of Use</li>
            ...
            <p>
              The website and its entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by The Peculiar House Global, its licensors, or other providers of such material and are protected by copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.
            </p>
            ...
            <p>
              The Peculiar House Global may revise these Terms of Use at any time without notice. By using this website, you are agreeing to be bound by the then-current version of these Terms of Use.
            </p>
